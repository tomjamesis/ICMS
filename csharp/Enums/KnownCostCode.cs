...
namespace csharp.Enums
{
    public class KnownCostCode
    {
        ...
        public KnownCostCode()
        {
            ...
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_010, CostCodes.Languages.en, "Pipelines-Construction Costs-Demolition, site preparation and formation"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_020, CostCodes.Languages.en, "Pipelines-Construction Costs-Substructure"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_030, CostCodes.Languages.en, "Pipelines-Construction Costs-Structure"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_040, CostCodes.Languages.en, "Pipelines-Construction Costs-Architectural works | Non-structural works"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_050, CostCodes.Languages.en, "Pipelines-Construction Costs-Services and equipment"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_060, CostCodes.Languages.en, "Pipelines-Construction Costs-Surface and underground drainage"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_070, CostCodes.Languages.en, "Pipelines-Construction Costs-External and ancillary works"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_080, CostCodes.Languages.en, "Pipelines-Construction Costs-Preliminaries | Constructor's site overheads | general requirements"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_090, CostCodes.Languages.en, "Pipelines-Construction Costs-Risk Allowances"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_CC_095, CostCodes.Languages.en, "Pipelines-Construction Costs-Taxes and Levies"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_AC_010, CostCodes.Languages.en, "Pipelines-Associated Costs (each including taxes)-Work and utilities off-site"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_AC_020, CostCodes.Languages.en, "Pipelines-Associated Costs (each including taxes)-Post-completion loose furniture, fittings and equipment"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_AC_030, CostCodes.Languages.en, "Pipelines-Associated Costs (each including taxes)-Construction-related consultants and supervision"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_AC_040, CostCodes.Languages.en, "Pipelines-Associated Costs (each including taxes)-Risk Allowances"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_SC_010, CostCodes.Languages.en, "Pipelines-Site Acquisition and Client's Other Costs (each including risks and taxes)-Site acquisition"));
            Values.Add(new CostCodes(CostCodes.Codes.PL_SC_020, CostCodes.Languages.en, "Pipelines-Site Acquisition and Client's Other Costs (each including risks and taxes)-Client's administrative, finance, legal and marketing expenses"));
